...
public class SncfHandlerFactory extends BaseThingHandlerFactory {
    ...
    protected @Nullable ThingHandler createHandler(Thing thing) {
        ...
        if (APIBRIDGE_THING_TYPE.equals(thingTypeUID)) {
            SncfBridgeHandler bridgeHandler = new SncfBridgeHandler((Bridge) thing);
    ...
    protected void removeHandler(ThingHandler thingHandler) {
        if (thingHandler instanceof SncfBridgeHandler) {
    ...
    private void registerDeviceDiscoveryService(SncfBridgeHandler bridgeHandler) {
        SncfDiscoveryService discoveryService = new SncfDiscoveryService(bridgeHandler, locationProvider);
